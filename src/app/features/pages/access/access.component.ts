...
export class AccessComponent implements OnInit {
    ...
    goBack(): void {
        this.formErrorMessage.set(null);
        if (this.view() !== ACCESS_VIEW.DEFAULT) {
            this.view.set(ACCESS_VIEW.DEFAULT);
        } else {
    ...
    //     this.usersService
    //         .addUser(this.username(), this.name(), this.password())
    //         .subscribe((user) => {
    //             if (user) {
    ...
    //             } else {
    //                 this.formErrorMessage.set('Erreur lors de la création du compte');
    //             }
    //         });
    // }
}
